...
export function MenuRoot({
  ...
  const value = useMemo<MenuContextValue>(
    () => ({ open, setOpen, anchorRef, contentRef, manualRect, triggerId, contentId }),
    [open, setOpen, manualRect, triggerId, contentId],
  );
...
export function MenuContent({
  ...
  const { open, setOpen, anchorRef, contentRef, manualRect, triggerId, contentId } =
    useMenuContext();
  const rect = useAnchorRect(anchorRef, open, manualRect);
