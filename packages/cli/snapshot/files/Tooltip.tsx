...
export function TooltipRoot({
  ...
  const value = useMemo<TooltipContextValue>(
    ...
    [open, setOpen, triggerEl, contentEl, triggerId, contentId, show, hide],
  );
...
export const TooltipTrigger = forwardRef<HTMLElement, TooltipTriggerProps>(function TooltipTrigger(
  ...
  const { setTriggerEl, show, hide, open, contentId, triggerId } =
...
export const TooltipContent = forwardRef<HTMLDivElement, TooltipContentProps>(
  function TooltipContent({ className, children, side = 'top', sideOffset = 6, ...props }, ref) {
    const { open, triggerEl, contentEl, setContentEl, contentId, triggerId } =
